from ycappuccino_core.models.decorators  import Item, Property,  Reference, ItemReference, Empty
...
@App(name="test")
@Item(collection="tests" ,name="test", plural="tests",  secure_write=True, secure_read=True)
class Test(Model):
