...
from ycappuccino_service_comm_storage.api import IRemoteStorageFactory

_logger = logging.getLogger(__name__)


@ComponentFactory('storageFactory-Factory')
@Provides(specifications=[YCappuccinoRemote.__name__, IStorageFactory.__name__], controller="_available")
