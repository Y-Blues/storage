        ...
        for key in self._dict.keys():
            ...
            if w_key_model is not None and w_key_model in self.__dict__:
                ...
                if "_item_id" in self._dict[key].keys():
                    ...
                    w_instance_subitem = ycappuccino_storage.models.model.create_item(
                        w_subitem, self._dict[key]
                    )
                ...
                for w_elem in self._dict[key]:
                    if isinstance(w_elem, dict):
                        if "_item_id" in w_elem.keys():
                            ...
                            w_instance_subitem = (
                                ycappuccino_storage.models.model.create_item(
                                    w_subitem, w_elem
                                )
                            )
                            w_instance_subitem.on_read(a_aggregate)
                            self._mongo_model[key].append(
                                w_instance_subitem._mongo_model
                            )
